...
export default class RetrieveUsersController {
   ...
   * @description Get a paginated list of all active users with their roles. Supports optional email filter for specific user lookup.
   * @paramQuery email - Filter by user email (optional) - @type(string)
